  ...
  try {
    ...
    const smsMessage = `
      ...
      ${type === 'schedule' 
        ...
        : `We regret to inform you that your appointment for ${formatDateTime(appointment.schedule!)} with Dr. ${appointment.primaryPhysician} has been cancelled for the following reason: ${appointment.cancellationReason}.`
      }
    `
